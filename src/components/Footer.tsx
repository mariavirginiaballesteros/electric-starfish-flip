...
import { Globe, Mail, Phone, Instagram, Linkedin, Facebook, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600">
              <li className="flex items-center gap-2"><Mail size={16} className="text-accent-yellow" /> info@coovaeco.com</li>
              <li className="flex items-center gap-2"><Phone size={16} className="text-accent-yellow" /> +54 11 4321-0000</li>
              <li className="flex items-center gap-2"><MapPin size={16} className="text-accent-yellow" /> Buenos Aires, Argentina</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-accent-yellow hover:text-white transition-all">
                <Instagram size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-accent-yellow hover:text-white transition-all">
                <Linkedin size={20} />
